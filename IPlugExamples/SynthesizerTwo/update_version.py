...
def main():
  ...
  plistpath = scriptpath + "/resources/SynthesizerTwo-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthesizerTwo-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthesizerTwo-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthesizerTwo-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthesizerTwo-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthesizerTwo-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/SynthesizerTwo-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/SynthesizerTwo.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SynthesizerTwo.iss",inplace=1):
