...
def main():
  ...
  plistpath = scriptpath + "/resources/DistortionThing-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThing-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThing-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThing-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThing-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThing-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DistortionThing-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DistortionThing.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DistortionThing.iss",inplace=1):
