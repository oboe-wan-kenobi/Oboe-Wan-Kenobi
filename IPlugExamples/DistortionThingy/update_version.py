...
def main():
  ...
  plistpath = scriptpath + "/resources/DistortionThingy-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThingy-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThingy-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThingy-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThingy-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionThingy-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DistortionThingy-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DistortionThingy.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DistortionThingy.iss",inplace=1):
